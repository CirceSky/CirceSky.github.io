    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("halfox's Windows", 'Hello，你好，欢迎来到半狐先生的系统小分站！<br/>个人主页：' + '<a style="color: white" target="_blank" href="http://halfox.cn/">halfox.cn </a><br />本网站 UI 由 ' + '<a style="color: white" target="_blank" href="https://ylui.yuri2.cn"> YLUI </a> 强力驱动<p>欢迎使用微信扫描二维码对作者进行捐赠~<br/><br/><img style="width: 100%" src="https://s4.ax1x.com/2022/02/12/HwgYBq.png"/></p>');
            }, 1500)
          });
        }
